...
pkglibexecdir = $(libexecdir)/x11vnc
...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/rfbconfig.h.in $(srcdir)/x11vnc.spec.in COPYING TODO \
...
CFLAGS = -g -O2 -Wall
CPP = gcc -E
CPPFLAGS =  -I/usr/local/src/static_libs/libjpeg/include
CRYPT_LIBS = -lcrypt
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
LDFLAGS =  -L/usr/local/src/static_libs/libjpeg/lib -Xlinker -R/usr/local/src/static_libs/libjpeg/lib
LIBOBJS = 
...
X_PRE_LIBS = 
abs_builddir = /usr/local/src/wizhelper/x11vnc
abs_srcdir = /usr/local/src/wizhelper/x11vnc
abs_top_builddir = /usr/local/src/wizhelper/x11vnc
abs_top_srcdir = /usr/local/src/wizhelper/x11vnc
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /usr/local/src/wizhelper/x11vnc/install-sh
...
SUBDIRS = libvncserver libvncclient x11vnc  
DIST_SUBDIRS = libvncserver libvncclient x11vnc
X11VNC = x11vnc
all: rfbconfig.h
