...
} rfbDataEncryptCheckMsg;

#define sz_rfbDataEncryptCheckMsg	2
#define rfbDataEncryptCheck			0x33


typedef struct {
	unsigned char type;			/* always rfbSetPenMode */
	unsigned char onoff;
...
#define sz_rfbPenModeMsg 12
#define rfbPenMode 0x13
